...
const allNamedReferences = Object.assign(Object.assign({}, namedReferences), { all: namedReferences.html5 });
...
const decodeRegExps = Object.assign(Object.assign({}, baseDecodeRegExps), { all: baseDecodeRegExps.html5 });
...
export function decode(text, { level = 'all', scope = level === 'xml' ? 'strict' : 'body' } = defaultDecodeOptions) {
    ...
    return replaceUsingRegExp(text, decodeRegExp, (entity) => getDecodedEntity(entity, references, isAttribute, isStrict));
}
