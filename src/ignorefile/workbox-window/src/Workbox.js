...
class Workbox extends WorkboxEventTarget {
    ...
    constructor(scriptURL, registerOptions = {}) {
         ...
         * @param {Event} originalEvent
         */
        this._onMessage = (originalEvent) => __awaiter(this, void 0, void 0, function* () {
    ...
    register({ immediate = false } = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!immediate && document.readyState !== 'complete') {
                yield new Promise((res) => window.addEventListener('load', res));
            }
            ...
            this._registration = yield this._registerScript();
    ...
    _registerScript() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const reg = yield navigator.serviceWorker.register(this._scriptURL, this._registerOptions);
