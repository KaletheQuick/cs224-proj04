...
class InjectManifest {
    ...
    apply(compiler) {
        ...
        if ((_a = webpack.version) === null || _a === void 0 ? void 0 : _a.startsWith('4.')) {
     ...
     * @private
     */
    performChildCompilation(compilation, parentCompiler) {
     ...
     * @private
     */
    handleMake(compilation, parentCompiler) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
            ...
            if (this.config.compileSrc) {
                yield this.performChildCompilation(compilation, parentCompiler);
            }
            else {
    ...
    addAssets(compilation) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { size, sortedEntries } = yield getManifestEntriesFromCompilation(compilation, config);
            ...
            if (sourcemapAssetName) {
                ...
                const { source, map } = yield replaceAndUpdateSourceMap({
